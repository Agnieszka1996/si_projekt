 ...
 */
final class Version20200607130741 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE tasks CHANGE tasklist_id tasklist_id INT DEFAULT NULL, CHANGE author_id author_id INT UNSIGNED NOT NULL, CHANGE term term DATETIME DEFAULT NULL, CHANGE description description VARCHAR(255) DEFAULT NULL, CHANGE comment comment VARCHAR(255) DEFAULT NULL');
