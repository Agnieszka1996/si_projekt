 ...
 */
final class Version20200614133955 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE notes CHANGE author_id author_id INT UNSIGNED NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE notes CHANGE author_id author_id INT UNSIGNED DEFAULT NULL');
