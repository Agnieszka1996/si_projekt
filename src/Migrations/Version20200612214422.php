 ...
 */
final class Version20200612214422 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE users_data (id INT AUTO_INCREMENT NOT NULL, user_id INT UNSIGNED NOT NULL, nick VARCHAR(45) DEFAULT NULL, firstname VARCHAR(45) DEFAULT NULL, surname VARCHAR(45) DEFAULT NULL, bio VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_627ABD6DA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
